...
import { PATHS, MODULE_PATHS } from '../../assets/js/core/config.js';
...
export function init() {
    ...
    function loadBlueprint() {
        ...
        // ✅ Use config (important)
        const path = `${PATHS.base}${MODULE_PATHS.ems}data/blueprints/class${classValue}/${subjectValue}.json`;
