...
async function initSyllabusBuilder() {
  try {
    ...
    const [sessions, classes, subjects, mapping, examTypes] = await Promise.all([
      loadJSON(path("/neoapps/data/academic/sessions.json")),
      loadJSON(path("/neoapps/data/academic/classes.json")),
      loadJSON(path("/neoapps/data/academic/subjects.json")),
      loadJSON(path("/neoapps/data/academic/class-subjects.json")),
      loadJSON(path("/neoapps/data/academic/exam-types.json"))
    ]);
